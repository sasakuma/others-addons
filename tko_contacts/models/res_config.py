...
class CRMSettings(models.TransientModel):
    ...
    module_tko_partner_multiple_phones = fields.Boolean(
        "Manage Multiple Phones ?",
        help="Manage multiple partner phones")
    module_tko_partner_multiple_emails = fields.Boolean(
        "Manage Multiple Emails ?",
        help="Manage multiple partner Emails")
    module_tko_partner_multiple_addresses = fields.Boolean(
        "Manage Multiple Addresses ?",
        help="Manage multiple partner Addresses")
    module_tko_partner_multiple_assets = fields.Boolean(
